...
<div id="thongbao" style="display: none; border-radius: 16px; position: absolute; right: 0; bottom: 0; border: 2px solid red; width: 400px; height: 400px; background: #eee; padding: 5px;">

<div class="">
  <div class="panel-heading" style="background: red; margin-top: 10px;">
    <h2 class="panel-title" style="color: white;">Cảnh báo!</h2>
  </div>
  <div class="panel-body" style="overflow: auto;">
  <br /> Website của quý khách sẽ chậm hoặc đơ.
  <p>
  Nguyên nhân cơ sở dữ liệu có <b class="socv"></b> công việc đang sử lý mất quá 30s
  
  </p>  
  
  <p><strong>Cách 1:</strong>  khắc phục tạm thời dừng công việc đăng số lại đến khi không còn cảnh báo</p>
  
  <p><strong>Cách 2:</strong>  Giảm bớt số lượng sim để hệ thống sử dụng tài nguyên ram và cpu ít đi</p>
   <p><strong>Cách 3:</strong>  Nâng cấp gói cao hơn!</p>
   <p style="color: red;"> Nếu website bị đơ quý khác vào <a href="index.php?do=processlist">Công việc</a> kill công việc và làm lại.</p>
...
function checkload()
{
    ...
    $.get('index.php?ajax=processlist.ajax').done(function(data){
