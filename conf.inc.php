...
define('DB_USER', $home_db_user);
define('DB_PASS', $home_db_pass);
define('DB_DATABASE', $home_db_db);

define('ADM_DB_USER', $admin_db_user);
define('ADM_DB_PASS', $admin_db_pass);
define('ADM_DB_DATABASE', $admin_db_db);




define('CRON_DB_DATABASE', ADM_DB_DATABASE);
define('TABLE_SIM', "sim");
define('TEMPLATE','template');


$config=[];
$config['theme']=['menu' => 'box/menu1.htm',
'search' => 'box/search_none_xs1.htm',
'mobiebar' => 'mobilebar1.htm',
'style' => 'paper'
];
...
function create_loai($loai,$sloai)
{
   ...
   $str="";
    foreach ($loai AS $link_url => $link_name)
    {
        ...
        $str.="<a class=\"list-group-item\" href='".$link_url.".html'><strong>".$link_name."</strong></a>
        ";
...
$_SESSION['style']=$config['theme']['style'];
define('thisdomain','https://'.$_SERVER["HTTP_HOST"]);

$settings=['template' => TEMPLATE, 'domain' => thisdomain];
$navmenu['VinaPhone']=array('091','094','0123', '0124', '0125', '0127', '0129');
$navmenu['MobiFone']=array('090','093','0120', '0121', '0122', '0126', '0128');
$navmenu['VietTel']=array('097','098','096','0162', '0163','0164', '0165', '0166', '0167', '0168', '0169');
$navmenu['VietNamobile']=array('092','0186','0188');
$navmenu['Gmobile']=array('099','0199');
...
function ss($l1=7,$l2=5)
{
    
   return "MID(sim2,-".$l1.",".$l2.")";
}




$loai['s']['sim-tu-quy-giua']="Sim tứ quý giữa";
$kieu['sim-tu-quy-giua']="


(".S1." != ".S2.") AND (".S54." IN (".sogannhau(4).") AND (".S5." != ".S6." ))
||
(".S2." != ".S3.") AND (".S64." IN (".sogannhau(4).") AND (".S6." != ".S7." ) )
||
(".S3." != ".S4.") AND  (".S74." IN (".sogannhau(4).") AND (".S7." != ".S8." ) )
||
(".S4." != ".S5.") AND  (".S84." IN (".sogannhau(4).") AND (".S8." != ".S9." ) )
||
(".S5." != ".S6.") AND  (".S94." IN (".sogannhau(4).") AND (".S9." != ".L1." ) )
...
$loai['s']['sim-luc-quy-giua']="Sim lục quý giữa";
$kieu['sim-luc-quy-giua']="
(".S1." != ".S2.") AND (".ss(7,6)." IN (".sogannhau(6).") AND (".ss(7,1)." != ".ss(8,1)." ))
||
(".S2." != ".S3.") AND (".ss(8,6)." IN (".sogannhau(6).") AND (".ss(8,1)." != ".ss(9,1)." ))
||
(".S3." != ".S4.") AND (".ss(9,6)." IN (".sogannhau(6).") AND (".ss(9,1)." != ".L1." ))
";


$loai['s']['sim-ngu-quy-giua']="Sim ngũ quý giữa";
$kieu['sim-ngu-quy-giua']="
(".S1." != ".S2.") AND (".ss(6,5)." IN (".sogannhau(5).") AND (".ss(6,1)." != ".ss(7,1)." ))
||
(".S2." != ".S3.") AND (".ss(7,5)." IN (".sogannhau(5).") AND (".ss(7,1)." != ".ss(8,1)." ))
||
(".S3." != ".S4.") AND (".ss(8,5)." IN (".sogannhau(5).") AND (".ss(8,1)." != ".ss(9,1)." ))
||
(".S4." != ".S5.") AND (".ss(9,5)." IN (".sogannhau(5).") AND (".ss(9,1)." != ".L1." ))
";
